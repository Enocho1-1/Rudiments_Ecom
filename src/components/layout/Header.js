...
export const Header = () => {
  ...
  useEffect(() => {setIsHidden(false)},[location.pathname])
  ...
  <nav className="bg-white border-gray-200 top-0 fixed z-20 w-screen">
      ...
      <div className="flex md:order-2">
        ...
        <div className={isHidden ? "items-center justify-between  w-full md:flex md:w-auto md:order-1" : "items-center justify-between hidden w-full md:flex md:w-auto md:order-1" } id="navbar-search">
          ...
          <ul className="flex justify-center p-4 md:p-0 mt-4 font-medium font-Bebas bg-white md:flex-row md:space-x-8 md:mt-0 md:border-0">
            <li>
                <NavLink to="/shop" className=" pl-3 pr-4 text-xl font-Bebas text-blk rounded hover:text-slate-500">
                 <span className="text-4xl  bi bi-bag-fill "> </span> 
                </NavLink>
            </li>
            ...
            <li>
              <NavLink to="/login" className=" pl-3 pr-4 text-xl font-Bebas text-blk rounded hover:text-slate-500">
                <span className="text-4xl bi bi-person-fill"> </span> 
              </NavLink>
            </li>
          </ul>
        </div>
